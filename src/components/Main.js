        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>At a point three hundred and sixty two metres above sea level, where a footpath crosses a long railway line is a gate. 
            ...
            <p>We combine technology expertise with years of creating digital products, propositions that delight millions of
              ...
              given the right environment can create outstanding results.  We've not always travelled the route we planed, because we've listened to customers and we've evolved our goals to suit conditions. We've gotten pretty good at creating a culture that succeeds.</p>
