...
console.log("nextEdgeVersion " + semver.inc(CURRENT_VERSION, 'patch', undefined, 'edge'));
console.log("nextStableVersion " + semver.inc(CURRENT_VERSION, 'minor', undefined, 'edge'));
